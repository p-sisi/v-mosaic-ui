...
.demo-block__source .hljs-tag { color: #89b4fa; }
.demo-block__source .hljs-name { color: #f38ba8; }
.demo-block__source .hljs-attr { color: #a6e3a1; }
.demo-block__source .hljs-string { color: #f9e2af; }
.demo-block__source .hljs-comment { color: #585b70; font-style: italic; }
.demo-block__source .hljs-keyword { color: #cba6f7; }
.demo-block__source .hljs-title { color: #89b4fa; }
.demo-block__source .hljs-params { color: #fab387; }
</style>